...
var Module = fx.Options(
	...
	fx.Module("application", fx.Provide(applicationwallet.NewService, applicationwagering.NewService, applicationingestion.NewService, applicationreference.NewService)),
	sqsadapter.Module,
